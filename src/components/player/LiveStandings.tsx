                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {wonEvents.length > 0 && (
                          <button
                            ...
                            title={isExpanded ? "Hide event wins" : "Show event wins"}
                          >
                    ...
                    {isExpanded && wonEvents.length > 0 && (
                      <tr key={`${team.id}-wins`} className="border-b border-border/50">
                        <td colSpan={4} className="px-0 py-0">
                          ...
                          >
                            <div className="bg-gold/[0.03] border-t border-gold/10 px-6 py-3 space-y-2">
                              <p className="text-[9px] font-bold uppercase tracking-widest text-gold/60 mb-2">
                                Event Wins · {wonEvents.length} total
                              </p>
                              {wonEvents.map((ev, j) => {
